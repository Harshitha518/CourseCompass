        ...
        NavigationStack {
            ScrollView(.vertical) {
                VStack(alignment: .leading) {
                    Text(student.studentName == "" ? "Your Schedule" : "\(student.studentName)'s Schedule")
                        .font(.title)
                        .padding(.leading, 50)
                        .scaleEffect(1.5)
...
struct electiveGradInfoView: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                Text(requirementsMet == true ? "Graduation Requirements Met" : "Graduation Requirements Not Met")
                    .font(.title2)
                    .padding()
                    .foregroundStyle(Color.accentColor)
                VStack {
                    Text(artsMet ? "You have met your Visual & Performing Arts requirements." : "You have not met your Visual & Performing Arts requirements.")
                        .bold()
                        .font(.title)
                        .foregroundStyle(artsMet ? Color(.science) : Color(.math))
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)
                        .padding()
                    ...
                    Text(careerMet ? "You have met your Career Education requirements." : "You have not met your Career Education requirements.")
                        ...
                        .font(.title)
                        .multilineTextAlignment(.center)
                        .foregroundStyle(careerMet ? Color(.science) : Color(.math))
                        .fixedSize(horizontal: false, vertical: true)
                        .padding()
                    ...
                    Text(financialMet ? "You have met your Financial Literacy requirements." : "You have not met your Financial Literacy requirements.")
                        .bold()
                        .font(.title)
                        .foregroundStyle(financialMet ? Color(.science) : Color(.math))
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)
                        .padding()
                    Text("You must complete 2.5 Financial Literacy credits.")
                        .multilineTextAlignment(.center)
                        .fixedSize(horizontal: false, vertical: true)
                        .foregroundStyle(Color.accentColor)
                        .padding()
